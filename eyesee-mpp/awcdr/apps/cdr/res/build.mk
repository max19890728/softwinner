...
$(call copy-files-under, \
	$(TARGET_PATH)/$(BOARD_TYPE)/images/test/*, \
	$(TARGET_OUT)/target/usr/share/minigui/res/images \
)
...
$(call copy-files-under, \
	$(TARGET_PATH)/$(BOARD_TYPE)/fpga/*, \
	$(TARGET_OUT)/target/usr/share/minigui/res/fpga \
)

$(call copy-files-under, \
	$(TARGET_PATH)/$(BOARD_TYPE)/background/*, \
	$(TARGET_OUT)/target/usr/share/minigui/res/background \
)

$(call copy-files-under, \
	$(TARGET_PATH)/$(BOARD_TYPE)/data/*, \
	$(TARGET_OUT)/target/usr/share/minigui/res/data \
)
