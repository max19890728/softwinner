...
class USBModeWindow : public SystemWindow {
 ...
 public:
  ...
  /*********************************************************
          Name:    PreInitCtrl()
          Description:
              if use control's backgroundclor,we should imcomplete  this
     function
         **********************************************************/
  ...
  inline void SetUSBWinMessageReceiveFlag(bool flag) {
    ignore_message_flag_ = flag;
  }
