...
class NewPreview : public GUIPresenterBase,
                   public IPresenter,
...
*/
  ...
  /*
  *名称: int SetCamPreviewRect(int p_CamId, int p_x, int p_y, int p_width, int
  *p_height)
  *功能: 设置camera的显示位置
  *参数:
  *	p_CamId: camera id号 输入
  ...
  *修改: 创建2018/5/11
  */
  int SetCamPreviewRect(int p_CamId, int p_x, int p_y, int p_width,
                        int p_height);
