...
Application::Application()
    : handle_(HWND_NULL), current_form_(NULL), is_running_(false) {
  CreateHandle();
  ui_path_ = UI_BASE_PATH;
}

Application::~Application() { ::MainWindowThreadCleanup(GetHandle()); }
...
/*****************************************************************************
 ...
 Return:
    result is generated by the system
*****************************************************************************/
long int Application::WindowProc(HWND hwindow, unsigned int message,
...
void Application::DestroyHandle() { ::DestroyMainWindow(GetHandle()); }
...
/*****************************************************************************
 ...
 Return: the handle
*****************************************************************************/
HWND Application::GetHandle() { return handle_; }
...
*****************************************************************************/
Window* Application::GetCurrentWindow() { return current_form_; }
...
void Application::Run() {
  ...
  while (::GetMessage(&msg, GetHandle())) {
    ...
    if (!is_running_) {
      is_running_ = true;
      if (callback_ != nullptr) std::thread(callback_).detach();
    }
  }
  is_running_ = false;
...
/*****************************************************************************
 ...
 Return:
*****************************************************************************/
string Application::GetAppUIPath() { return ui_path_; }
...
/*****************************************************************************
 ...
 Return: -
*****************************************************************************/
void Application::SetAppUIPath(string path) { ui_path_ = path; }
