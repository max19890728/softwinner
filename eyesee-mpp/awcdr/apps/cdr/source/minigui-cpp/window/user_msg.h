...
typedef struct __item_info { const char *item_name; } iteminfo;

/******* {const char *item_name,  const char *unhilight_icon, const char
 * *hilight_icon, int type, int value }*********/
...
static menu_win menu_usb_win[] = {
    {"tl_usb_charge", "", "", "wifi_off", "wifi_on", "menu_unselect",
     "menu_select", 1, 0},
    {"tl_usb_mass_storage", "", "", "wifi_off", "wifi_on", "menu_unselect",
     "menu_select", 1, 0},
    {"tl_usb_webcam", "", "", "wifi_off", "wifi_on", "menu_unselect",
     "menu_select", 1, 0},
};

#ifdef SETTING_ITEM_DD  // add by zhb
static menu_win menu_record_win[] = {
    // this index must reference to
    // IPCLinuxPlatform/custom_aw/apps/sdv/source/common/setting_menu_id.h:SETTING_ITEM_DD_ID
    // index

    {"ml_record_resolution", "ml_record_resolution_sub_head",
     "ml_device_dash_camera_tips", "set_front_resolution_g",
     "set_front_resolution_w", "select_off", "select_m", 4, 2},
    {"ml_camera_autoscreensaver", "ml_camera_autoscreensaver_sub_head", "",
     "set_auto_screensaver_g", "set_auto_screensaver_w", "select_off",
     "select_m", 4, 4},
    {"ml_system_voice", "ml_system_voice_sub_head", "", "set_system_voice_g",
     "set_system_voice_w", "select_off", "select_m", 4, 2},
    {"ml_record_adas", "ml_record_adas_sub_head", "ml_record_adas_tips",
     "set_adas_g", "set_adas_w", "select_off", "select_m", 4, 2},
    {"ml_account_bingding", "ml_account_binging_sub_head", "", "set_account_g",
     "set_account_w", "select_off", "select_m", 5, 0},
    {"ml_device_deviceinfo", "ml_device_deviceinfo_sub_head", "",
     "set_device_info_g", "set_device_info_w", "select_off", "select_m", 5, 0},
    {"ml_device_version_update", "ml_device_version_update_sub_head", "",
     "set_version_g", "set_version_w", "select_off", "select_m", 6, 0},
    // no use
    {"ml_device_language", "ml_device_language_sub_head", "", "set_language_g",
     "set_language_w", "select_off", "select_m", 4, 2},  ////
    {"ml_wifi_connect", "ml_wifi_connect_sub_head", "", "set_wifi_g",
     "set_wifi_w", "select_off", "select_m", 4, 2},  ////
    {"ml_screen_brightness", "ml_screen_brightness_sub_head", "",
     "set_screen_brightness_g", "set_screen_brightness_w", "select_off",
     "select_m", 4, 1},
    {"ml_device_sdcard_info", "ml_device_sdcard_info_sub_head", "",
     "set_sdcard_g", "set_sdcard_w", "select_off", "select_m", 5, 0},
    {"ml_device_time", "ml_device_time_sub_head", "ml_device_time_save_tips",
     "set_update_time_g", "set_update_time_w", "select_off", "select_m", 6,
     1},  // if has the manual adjust time is 2
    {"ml_system_acc", "ml_system_acc_sub_head", "", "set_system_acc_g",
     "set_system_acc_w", "select_off", "select_m", 4, 2},

    {"ml_record_rear_resolution", "ml_record_rear_resolution_sub_head",
     "ml_record_rear_resolution_tips", "set_rear_resolution_w",
     "set_rear_resolution", "select_off", "select_m", 4, 2},
    {"ml_record_volume", "ml_record_volume_sub_head", "", "set_mic_w",
     "set_mic", "select_off", "select_m", 4, 2},
    {"ml_record_timewatermark", "ml_record_timewatermark_sub_head",
     "ml_record_timewatermark_tips", "set_data_watermark_w",
     "set_data_watermark", "select_off", "select_m", 4, 2},
    {"ml_record_emerrecord", "ml_record_emerrecord_sub_head",
     "ml_record_emerrecord_tips", "set_emer_record_w", "set_emer_record",
     "select_off", "select_m", 4, 2},
    {"ml_voice_photo", "ml_voice_photo_sub_head", "ml_voice_photo_tips",
     "set_voice_photo_w", "set_voice_photo", "select_off", "select_m", 4, 2},
    {"ml_4g_network", "ml_4g_network_sub_head", "", "set_4g_network_w",
     "set_4g_network", "select_off", "select_m", 4, 2},
    {"ml_record_adas", "ml_record_adas_sub_head", "ml_record_adas_tips",
     "set_adas_w", "set_adas", "select_off", "select_m", 4, 2},
    {"ml_watch_dog", "ml_watch_dog_sub_head", "", "set_watchdog_w",
     "set_watchdog", "select_off", "select_m", 4, 2},
    {"ml_record_parkingmonitor", "ml_record_parkingmonitor_sub_head", "",
     "set_packing_monitory_w", "set_packing_monitory", "select_off", "select_m",
     4, 4},
    {"ml_record_standby_clock", "ml_record_standby_clock_sub_head",
     "ml_record_standby_clock_tips", "set_standby_clock_w", "set_standby_clock",
     "select_off", "select_m", 4, 2},
    {"ml_driver_report", "ml_driver_report_sub_head", "", "set_driver_report_w",
     "set_driver_report", "select_off", "select_m", 4, 2},

    //
    {"ml_record_emerrecordsen", "ml_record_emerrecordsen", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 4},  //
    {"ml_record_loop", "ml_record_loop", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 4},  //
    {"ml_device_resetfactory", "ml_device_resetfactory", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 0},  //
    {"ml_screen_disturb_mode", "ml_screen_disturb_mode", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 2},
    {"ml_record_adas_forward_collision_warning",
     "ml_record_adas_forward_collision_warning", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 2},
    {"ml_record_adas_lane_shift_reminding",
     "ml_record_adas_lane_shift_reminding", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 2},
    {"ml_volume_select", "ml_volume_select", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 7},
    {"ml_power_on_voice", "ml_power_on_voice", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 2},
    {"ml_key_voice", "ml_key_voice", "", "wifi_off", "wifi_on", "select_off",
     "select_m", 4, 2},
    {"ml_packing_warn_lamp", "ml_packing_warn_lamp", "", "wifi_off", "wifi_on",
     "select_off", "select_m", 4, 2},
    {"ml_packing_abnormal_monitor", "ml_packing_abnormal_monitor", "",
     "wifi_off", "wifi_on", "select_off", "select_m", 4, 2},
    {"ml_packing_abnormal_notice", "ml_packing_abnormal_notice", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 2},
    {"ml_record_parkingloop_sw", "ml_record_parkingloop_sw", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 2},
};
#else
...
static menu_win menu_record_win[] = {
    {"ml_record_resolution", "ml_record_resolution_sub_head",
     "ml_record_resolution_tips", "set_front_resolution_w",
     "set_front_resolution", "select_off", "select_m", 4, 2},
    {"ml_record_rear_resolution", "ml_record_rear_resolution_sub_head",
     "ml_record_rear_resolution_tips", "set_rear_resolution_w",
     "set_rear_resolution", "select_off", "select_m", 4, 2},
    {"ml_record_volume", "ml_record_volume_sub_head", "", "set_mic_w",
    ...
    {"ml_record_timewatermark", "ml_record_timewatermark_sub_head",
     ...
     "set_data_watermark", "select_off", "select_m", 4, 2},
    {"ml_screen_brightness", "ml_screen_brightness_sub_head", "",
     "set_screen_brightness_w", "set_screen_brightness", "select_off",
     "select_m", 4, 1},
    {"ml_camera_autoscreensaver", "ml_camera_autoscreensaver_sub_head", "",
     "set_auto_screensaver_w", "set_auto_screensaver", "select_off", "select_m",
     4, 4},
    {"ml_record_emerrecord", "ml_record_emerrecord_sub_head",
     "ml_record_emerrecord_tips", "set_emer_record_w", "set_emer_record",
     "select_off", "select_m", 4, 2},
    {"ml_voice_photo", "ml_voice_photo_sub_head", "ml_voice_photo_tips",
     "set_voice_photo_w", "set_voice_photo", "select_off", "select_m", 4, 2},
    {"ml_wifi_connect", "ml_wifi_connect_sub_head", "ml_wifi_connect_tips",
     "set_wifi_w", "set_wifi", "select_off", "select_m", 4, 2},
    {"ml_4g_network", "ml_4g_network_sub_head", "", "set_4g_network_w",
     "set_4g_network", "select_off", "select_m", 4, 2},
    {"ml_device_time", "ml_device_time_sub_head", "ml_device_time_save_tips",
     "set_update_time_w", "set_update_time", "select_off", "select_m", 6,
     1},  // if has the manual adjust time is 2
    {"ml_record_adas", "ml_record_adas_sub_head", "ml_record_adas_tips",
     "set_adas_w", "set_adas", "select_off", "select_m", 4, 2},
    {"ml_watch_dog", "ml_watch_dog_sub_head", "", "set_watchdog_w",
    ...
    {"ml_record_standby_clock", "ml_record_standby_clock_sub_head",
     "ml_record_standby_clock_tips", "set_standby_clock_w", "set_standby_clock",
     "select_off", "select_m", 4, 2},
    {"ml_system_voice", "ml_system_voice_sub_head", "", "set_system_voice_w",
     "set_system_voice", "select_off", "select_m", 4, 2},
    {"ml_driver_report", "ml_driver_report_sub_head", "", "set_driver_report_w",
     "set_driver_report", "select_off", "select_m", 4, 2},
    {"ml_device_language", "ml_device_language_sub_head", "", "set_language_w",
     "set_language", "select_off", "select_m", 4, 2},
    {"ml_device_deviceinfo", "ml_device_deviceinfo_sub_head", "",
     "set_device_info_w", "set_device_info", "select_off", "select_m", 5, 0},
    {"ml_device_sdcard_info", "ml_device_sdcard_info_sub_head", "",
     "set_sdcard_w", "set_sdcard", "select_off", "select_m", 5, 0},
    {"ml_device_version_update", "ml_device_version_update_sub_head", "",
     "set_version_w", "set_version", "select_off", "select_m", 6, 0},
    //
    {"ml_record_emerrecordsen", "ml_record_emerrecordsen", "", "wifi_off",
     "wifi_on", "select_off", "select_m", 4, 4},  //
    {"ml_record_loop", "ml_record_loop", "", "wifi_off", "wifi_on",
...
static msg_map msg_map_[] = {
    ...
    {"ml_record_parkingloop_resolution",
...
static submenu_bind packingmonitory_[] = {
    ...
    {"ml_record_parkingloop_resolution", 7,
     SETTING_PARKING_RECORD_LOOP_RESOLUTION}};

#define NUM_ADAS 2
static submenu_bind adas_[] = {
    {"ml_record_adas_forward_collision_warning", 1,
     SETTING_FORWARD_COLLISION_WARNING},
...
static submenu_bind network_4g_[] = {
    {"ml_traffic_info_query", 6, -1}, {"ml_flow_recharge", 6, -1},
};
...
static iteminfo device_info_[] = {
    {"ml_device_deviceinfo_sn"},         {"ml_device_deviceinfo_sim"},
    {"ml_device_deviceinfo_account_id"}, {"ml_device_deviceinfo_imei_id"},
    {"ml_device_deviceinfo_view"},       {"ml_device_resetfactory"},
};

#define NUM_ACCOUNT_INFO 4
static iteminfo account_info_[] = {
    {"ml_account_info_id"},          {"ml_account_unbinding_info_1"},
    {"ml_account_unbinding_info_2"}, {"ml_account_binding_button"},
...
typedef struct __ListViewItem {
  ...
  const int type;
  const char *second_icon_path0;  // 如果第二个是button，这个保存unselect
                                  // 图片,否则保存平常图片
...
static ListViewItem ListBoxItemData[] = {
    ...
    {"sw_screensaver", "ml_camera_autoscreensaver", TYPE_NORMAL, "sw_switch",
     NULL},

    {"sw_resolution", "ml_record_resolution", TYPE_NORMAL, "sw_switch", NULL},
    // {"set_front_resolution_w", "ml_record_rear_resolution", TYPE_NORMAL,
    // "menu_select", NULL},
  ...
  {"sw_quality", "ml_photo_Quality", TYPE_NORMAL, "sw_switch", NULL},
    ...
    {"sw_record_timelaps", "ml_record_timelapse", TYPE_NORMAL, "sw_switch",
     NULL},
#endif

    {"sw_encode_type", "ml_record_encodingtype", TYPE_NORMAL, "sw_switch",
     NULL},
    {"sw_exposure", "ml_camera_exposure", TYPE_NORMAL, "sw_switch", NULL},
    // {"sw_park", "ml_record_parkingmonitor", TYPE_SWITCH, "sw_button_off",
    // "sw_button_on"},
    {"sw_emerrecord_sen", "ml_record_emerrecordsen", TYPE_NORMAL, "sw_switch",
     NULL},
    {"sw_language", "ml_device_language", TYPE_NORMAL, "sw_switch", NULL},
    {"sw_volume", "ml_record_volume", TYPE_SWITCH, "sw_button_off",
     "sw_button_on"},
    {"sw_volume", "ml_volume_select", TYPE_NORMAL, "sw_switch", NULL},
    {"sw_wifi", "ml_wifi_select", TYPE_SWITCH, "sw_button_off", "sw_button_on"},
    {"sw_awmd", "ml_motion_detect", TYPE_SWITCH, "sw_button_off",
     "sw_button_on"},
    {"sw_light_fre", "ml_camera_lightsourcefrequency", TYPE_NORMAL, "sw_switch",
     NULL},
