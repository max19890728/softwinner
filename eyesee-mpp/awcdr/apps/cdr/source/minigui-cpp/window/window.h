...
class Window : public ContainerWidget, public IObserverWrap(Window) {
 ...
 public:
  ...
  static long int WindowProc(HWND hwnd, unsigned int msg, WPARAM wparam,
                             LPARAM lparam);
...
class SystemWindow : public Window {
 ...
 public:
  explicit SystemWindow(IComponent *parent);
