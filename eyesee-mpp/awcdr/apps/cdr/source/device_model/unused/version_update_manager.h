...
class VersionUpdateManager : public ISubjectWrap(VersionUpdateManager),
                             public EyeseeLinux::Singleton<VersionUpdateManager> {
  friend class EyeseeLinux::Singleton<VersionUpdateManager>;
 ...
 private:
  static int progress_func(char *progress_data, double t, double d,
