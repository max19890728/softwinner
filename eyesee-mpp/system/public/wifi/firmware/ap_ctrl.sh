...
ini_check_param ()
{
	...
	ap6212)
		DRIVER_PATH=/lib/modules/$(uname -r)/bcmdhd.ko
		CONFIG_PATH="etc/firmware/ap6212/"
		;;	
	*)
...
ap_load ()
{
	...
	ap6212)
		insmod ${DRIVER_PATH}
		usleep 2000
		echo "/etc/firmware/ap6212/fw_bcm43438a1_apsta.bin " > /sys/module/bcmdhd/parameters/firmware_path
		echo "/etc/firmware/ap6212/nvram_ap6212a.txt" >  /sys/module/bcmdhd/parameters/nvram_path
		mkdir -p /var/run/hostapd/
		touch /var/run/udhcpd.leases
		usleep 2000
		ifconfig wlan0 up
...
{
	case ${DEVICE_NAME} in
	ap6255 | ap6335 | ap6181 | 8189ftv | ap6212)
		# ifconfig wlan0 down
		# usleep 6000
		rmmod ${DRIVER_PATH}
		usleep 2000
